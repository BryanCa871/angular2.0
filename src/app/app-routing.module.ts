...
const routes: Routes = [
  {path: 'alumnos', component: AlumnoComponent, canActivate: [ LoginGuard], data: {roles: [1]}},
  {path: 'alumnos/crear', component: AlumnoCrearComponent, canActivate: [LoginGuard]},
  {path: 'alumnos/:id/edit', component: AlumnoEditarComponent, canActivate: [LoginGuard]},
  {path: 'editorial', component: EditorialComponent, canActivate: [LoginGuard], data: {roles: [1]}},
  ...
  {path: 'autor', component: AutorComponent, canActivate: [LoginGuard], data: {roles: [1]}},
  ...
  {path: 'pais', component: PaisComponent, canActivate: [LoginGuard], data: {roles: [1]}},
  ...
  {path: 'libro', component: LibroComponent, canActivate: [LoginGuard], data: {roles: [1]}},
  ...
  {path: 'provedor', component: ProvedoresComponent, canActivate: [LoginGuard], data: {roles: [1]}},
  ...
  {path: 'compra', component: ComprasComponent, canActivate: [LoginGuard], data: {roles: [1]}},
